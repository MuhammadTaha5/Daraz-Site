...
import { renderProductDetails } from "./renderers/productPage.js";
...
async function init() {
  try {
    ...
    const productDetailsSpec = await getProductById(productId);
    renderProductDetails(productDetailsSpec);
  } catch (error) {
